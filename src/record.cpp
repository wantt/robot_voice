...
ALSACaptureDevice microphone("plughw:2,0,0", SAMPLING_RATE, CHANNELS, FRAMES_PER_PERIOD, FORMAT);
ALSAPlaybackDevice speaker("plughw:2,0,0", SAMPLING_RATE, CHANNELS, FRAMES_PER_PERIOD, FORMAT);
...
//	printf("length of strlen is %d\n",strlen(buffer));
	mobvoi_send_speech_frame( (char *)buffer, sizeof(short)*strlen(buffer)); 
